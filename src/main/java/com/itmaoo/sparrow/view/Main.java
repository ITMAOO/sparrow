package com.itmaoo.sparrow.view;
...
public class Main {
	...
	public Main() throws ClassNotFoundException, InstantiationException, IllegalAccessException,
		...
		mainFrame = new JFrame("麻雀-轻量级信息管理系统");
	...
	JPanel getLogoPanel() {
		...
		ImageIcon editIcon1 = new ImageIcon("resources/title.png");
		...
		ImageIcon editIcon = new ImageIcon("resources/logout.png");
